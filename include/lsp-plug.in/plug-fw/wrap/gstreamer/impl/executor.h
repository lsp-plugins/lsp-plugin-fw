...
#ifndef LSP_PLUG_IN_PLUG_FW_WRAP_GSTREAMER_IMPL_EXECUTOR_H_
#define LSP_PLUG_IN_PLUG_FW_WRAP_GSTREAMER_IMPL_EXECUTOR_H_
...
#endif /* LSP_PLUG_IN_PLUG_FW_WRAP_GSTREAMER_IMPL_EXECUTOR_H_ */

...
#define UI_IR_LIST_NAVIGATION_AUTOLOAD_PORT     UI_CONFIG_PORT_PREFIX UI_IR_LIST_NAVIGATION_AUTOLOAD_ID
#define UI_IR_LIST_NAVIGATION_AUTOPLAY_PORT     UI_CONFIG_PORT_PREFIX UI_IR_LIST_NAVIGATION_AUTOPLAY_ID
#define UI_TAKE_INST_NAME_FROM_FILE_PORT        UI_CONFIG_PORT_PREFIX UI_TAKE_INST_NAME_FROM_FILE_ID
#define UI_SHOW_PIANO_LAYOUT_ON_GRAPH_PORT      UI_CONFIG_PORT_PREFIX UI_SHOW_PIANO_LAYOUT_ON_GRAPH_ID
#define UI_CONFIG_USER_FRIENDLY_VALUES_PORT     UI_CONFIG_PORT_PREFIX UI_CONFIG_USER_FRIENDLY_VALUES_ID
#define UI_REVEAL_SAMPLE_ON_LISTEN_PORT         UI_CONFIG_PORT_PREFIX UI_REVEAL_SAMPLE_ON_LISTEN_ID
#define AUDIO_BACKEND_PORT                      UI_CONFIG_PORT_PREFIX AUDIO_BACKEND_ID

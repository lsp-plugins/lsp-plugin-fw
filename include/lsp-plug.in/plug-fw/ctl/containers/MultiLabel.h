...
#ifndef LSP_PLUG_IN_PLUG_FW_CTL_CONTAINERS_MULTILABEL_H_
#define LSP_PLUG_IN_PLUG_FW_CTL_CONTAINERS_MULTILABEL_H_
...
#endif /* LSP_PLUG_IN_PLUG_FW_CTL_CONTAINERS_MULTILABEL_H_ */

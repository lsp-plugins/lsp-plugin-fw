...
#define PORT_COMPARE_IFACE      lltl::compare_iface { lltl::char_cmp_func }
    ...
    namespace meta
    {
        ...
        static const meta::port_t config_metadata[] =
        {
            ...
            SWITCH(UI_FILELIST_NAVIGATION_AUTOLOAD_ID, "Automatically load sample files when navigating over file list", NULL, 1.0f),
            SWITCH(UI_FILELIST_NAVIGATION_AUTOPLAY_ID, "Enable automatic playback of the audio sample file in the file navigator when selected", NULL, 0.0f),
            SWITCH(UI_IR_LIST_NAVIGATION_AUTOLOAD_ID, "Automatically load IR files when navigating over file list", NULL, 0.0f),
            SWITCH(UI_IR_LIST_NAVIGATION_AUTOPLAY_ID, "Enable automatic playback of the IR file in the file navigator when selected", NULL, 0.0f),

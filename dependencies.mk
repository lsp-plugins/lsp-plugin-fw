...
LINUX_DEPENDENCIES_STANDALONE = \
  ...
  LIBRT \
  LIBSNDFILE \
  $(call fcheck,test,$(OVERALL_FEATURES), \
    $(call fcheck,jack,$(OVERALL_FEATURES),LIBJACK) \
  )
...
LINUX_DEPENDENCIES_STANDALONE_BIN = \
  $(call fcheck,jack,$(OVERALL_FEATURES), LSP_AUDIO_JACK_LIB)
...
ifeq ($(PLATFORM),MacOS)
  ...
  DEPENDENCIES_STANDALONE          += $(MACOS_DEPENDENCIES_JACK)
  DEPENDENCIES_STANDALONE_UI       += $(MACOS_DEPENDENCIES_JACK_UI)
  DEPENDENCIES_STANDALONE_WRAP     += $(MACOS_DEPENDENCIES_JACK_WRAP)
  DEPENDENCIES_STANDALONE_BIN      += $(MACOS_DEPENDENCIES_JACK_BIN)
  DEPENDENCIES_STANDALONE_UI_BIN   += $(MACOS_DEPENDENCIES_JACK_UI_BIN)

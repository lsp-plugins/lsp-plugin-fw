...
# Stanadalone dependencies
DEPENDENCIES_STANDALONE = \
  $(DEPENDENCIES_COMMON)

DEPENDENCIES_STANDALONE_UI = \
  $(DEPENDENCIES_COMMON_UI)

DEPENDENCIES_STANDALONE_WRAP = \
  LSP_COMMON_LIB \
  $(call fcheck,test,$(BUILD_FEATURES),LSP_TEST_FW)
  
DEPENDENCIES_STANDALONE_WRAP_OPT = \
  LSP_COMMON_LIB \
  LSP_TEST_FW

DEPENDENCIES_STANDALONE_BIN =

DEPENDENCIES_STANDALONE_UI_BIN =

DEPENDENCIES_STANDALONE_ALL = \
  $(DEPENDENCIES_STANDALONE) \
  $(DEPENDENCIES_STANDALONE_WRAP) \
  $(DEPENDENCIES_STANDALONE_WRAP_OPT) \
  $(DEPENDENCIES_STANDALONE_BIN)
  
DEPENDENCIES_STANDALONE_UI_ALL = \
  $(DEPENDENCIES_STANDALONE_UI) \
  $(DEPENDENCIES_STANDALONE_UI_BIN)
...
LINUX_TEST_DEPENDENCIES = \
  $(call fcheck,jack,$(BUILD_FEATURES),LSP_AUDIO_JACK_LIB) \
  $(call fcheck,pipewire,$(BUILD_FEATURES),LSP_AUDIO_PIPEWIRE_LIB)
...
LINUX_DEPENDENCIES_LAUNCHER_BIN = \
  LSP_R3D_GLX_LIB
...
LINUX_DEPENDENCIES_STANDALONE = \
  LIBDL \
  LIBPTHREAD \
  LIBRT \
  LIBSNDFILE \
  $(call fcheck,test,$(BUILD_FEATURES), \
    $(call fcheck,jack,$(BUILD_FEATURES),LIBJACK) \
    $(call fcheck,pipewire,$(BUILD_FEATURES),LIBPIPEWIRE) \
  )

LINUX_DEPENDENCIES_STANDALONE_OPT = \
  LIBJACK \
  LIBPIPEWIRE

LINUX_DEPENDENCIES_STANDALONE_UI = \
  LIBCAIRO \
  LIBDL \
  LIBFONTCONFIG \
  LIBFREETYPE \
...
LINUX_DEPENDENCIES_STANDALONE_WRAP = \
  LIBDL

LINUX_DEPENDENCIES_STANDALONE_WRAP_OPT =

LINUX_DEPENDENCIES_STANDALONE_BIN = \
  $(call fcheck,jack,$(BUILD_FEATURES), LSP_AUDIO_JACK_LIB) \
  $(call fcheck,pipewire,$(BUILD_FEATURES), LSP_AUDIO_PIPEWIRE_LIB)

LINUX_DEPENDENCIES_STANDALONE_BIN_OPT = \
  LSP_AUDIO_JACK_LIB \
  LSP_AUDIO_PIPEWIRE_LIB

LINUX_DEPENDENCIES_STANDALONE_UI_BIN = \
  LSP_R3D_GLX_LIB

LINUX_DEPENDENCIES_STANDALONE_ALL = \
  $(LINUX_DEPENDENCIES_STANDALONE) \
  $(LINUX_DEPENDENCIES_STANDALONE_OPT) \
  $(LINUX_DEPENDENCIES_STANDALONE_WRAP) \
  $(LINUX_DEPENDENCIES_STANDALONE_WRAP_OPT) \
...
ifeq ($(PLATFORM),Linux)
  ...
  DEPENDENCIES_LAUNCHER            += $(LINUX_DEPENDENCIES_LAUNCHER)
  DEPENDENCIES_LAUNCHER_BIN        += $(LINUX_DEPENDENCIES_LAUNCHER_BIN)
  ...
  DEPENDENCIES_STANDALONE          += $(LINUX_DEPENDENCIES_STANDALONE)
  DEPENDENCIES_STANDALONE_UI       += $(LINUX_DEPENDENCIES_STANDALONE_UI)
  DEPENDENCIES_STANDALONE_WRAP     += $(LINUX_DEPENDENCIES_STANDALONE_WRAP)
  DEPENDENCIES_STANDALONE_BIN      += $(LINUX_DEPENDENCIES_STANDALONE_BIN)
  DEPENDENCIES_STANDALONE_UI_BIN   += $(LINUX_DEPENDENCIES_STANDALONE_UI_BIN)
  DEPENDENCIES_STANDALONE_ALL      += $(LINUX_DEPENDENCIES_STANDALONE_ALL)
  DEPENDENCIES_STANDALONE_UI_ALL   += $(LINUX_DEPENDENCIES_STANDALONE_UI_ALL)
...
BSD_DEPENDENCIES_STANDALONE_OPT = \
  LIBJACK \
  LIBPIPEWIRE

BSD_DEPENDENCIES_STANDALONE_UI = \
  LIBCAIRO \
  LIBDL \
  LIBFONTCONFIG \
  LIBFREETYPE \
...
BSD_DEPENDENCIES_STANDALONE_WRAP = \
  LIBDL

BSD_DEPENDENCIES_STANDALONE_WRAP_OPT =

BSD_DEPENDENCIES_STANDALONE_BIN = \
  $(call fcheck,jack,$(BUILD_FEATURES),LSP_AUDIO_JACK_LIB) \
  $(call fcheck,pipewire,$(BUILD_FEATURES),LSP_AUDIO_PIPEWIRE_LIB)
  
BSD_DEPENDENCIES_STANDALONE_BIN_OPT = \
  LSP_AUDIO_JACK_LIB \
  LSP_AUDIO_PIPEWIRE_LIB

BSD_DEPENDENCIES_STANDALONE_UI_BIN = \
  LSP_R3D_GLX_LIB

BSD_DEPENDENCIES_STANDALONE_ALL = \
  $(BSD_DEPENDENCIES_STANDALONE) \
  $(BSD_DEPENDENCIES_STANDALONE_OPT) \
  $(BSD_DEPENDENCIES_STANDALONE_WRAP) \
  $(BSD_DEPENDENCIES_STANDALONE_WRAP_OPT) \
...
BSD_DEPENDENCIES_STANDALONE_UI_ALL = \
  $(BSD_DEPENDENCIES_STANDALONE_UI) \
  $(BSD_DEPENDENCIES_STANDALONE_UI_BIN)
...
ifeq ($(PLATFORM),BSD)
  ...
  DEPENDENCIES_LAUNCHER            += $(BSD_DEPENDENCIES_LAUNCHER)
  DEPENDENCIES_LAUNCHER_BIN        += $(BSD_DEPENDENCIES_LAUNCHER_BIN)
  ...
  DEPENDENCIES_STANDALONE          += $(BSD_DEPENDENCIES_STANDALONE)
  DEPENDENCIES_STANDALONE_UI       += $(BSD_DEPENDENCIES_STANDALONE_UI)
  DEPENDENCIES_STANDALONE_WRAP     += $(BSD_DEPENDENCIES_STANDALONE_WRAP)
  DEPENDENCIES_STANDALONE_BIN      += $(BSD_DEPENDENCIES_STANDALONE_BIN)
  DEPENDENCIES_STANDALONE_UI_BIN   += $(BSD_DEPENDENCIES_STANDALONE_UI_BIN)
  DEPENDENCIES_STANDALONE_ALL      += $(BSD_DEPENDENCIES_STANDALONE_ALL)
  DEPENDENCIES_STANDALONE_UI_ALL   += $(BSD_DEPENDENCIES_STANDALONE_UI_ALL)
...
WINDOWS_DEPENDENCIES_LAUNCHER_BIN = \
  LSP_R3D_WGL_LIB
...
# Standalone dependencies
WINDOWS_DEPENDENCIES_STANDALONE = \
  LIBSHLWAPI \
  LIBWINMM \
  LIBMSACM \
  LIBMPR

WINDOWS_DEPENDENCIES_STANDALONE_OPT =

WINDOWS_DEPENDENCIES_STANDALONE_UI = \
  LSP_R3D_WGL_LIB \
  LIBGDI32 \
  LIBD2D1 \
  LIBOLE \
...
WINDOWS_DEPENDENCIES_STANDALONE_WRAP =

WINDOWS_DEPENDENCIES_STANDALONE_WRAP_OPT =

WINDOWS_DEPENDENCIES_STANDALONE_BIN =

WINDOWS_DEPENDENCIES_STANDALONE_BIN_OPT =

WINDOWS_DEPENDENCIES_STANDALONE_UI_BIN = \
  LSP_R3D_WGL_LIB

WINDOWS_DEPENDENCIES_STANDALONE_ALL = \
  $(WINDOWS_DEPENDENCIES_STANDALONE) \
  $(WINDOWS_DEPENDENCIES_STANDALONE_OPT) \
  $(WINDOWS_DEPENDENCIES_STANDALONE_WRAP) \
  $(WINDOWS_DEPENDENCIES_STANDALONE_WRAP_OPT) \
...
WINDOWS_DEPENDENCIES_STANDALONE_UI_ALL = \
  $(WINDOWS_DEPENDENCIES_STANDALONE_UI) \
  $(WINDOWS_DEPENDENCIES_STANDALONE_UI_BIN)
...
ifeq ($(PLATFORM),Windows)
  ...
  DEPENDENCIES_LAUNCHER            += $(WINDOWS_DEPENDENCIES_LAUNCHER)
  DEPENDENCIES_LAUNCHER_BIN        += $(WINDOWS_DEPENDENCIES_LAUNCHER_BIN)
  ...
  DEPENDENCIES_STANDALONE          += $(WINDOWS_DEPENDENCIES_STANDALONE)
  DEPENDENCIES_STANDALONE_UI       += $(WINDOWS_DEPENDENCIES_STANDALONE_UI)
  DEPENDENCIES_STANDALONE_WRAP     += $(WINDOWS_DEPENDENCIES_STANDALONE_WRAP)
  DEPENDENCIES_STANDALONE_BIN      += $(WINDOWS_DEPENDENCIES_STANDALONE_BIN)
  DEPENDENCIES_STANDALONE_UI_BIN   += $(WINDOWS_DEPENDENCIES_STANDALONE_UI_BIN)
  DEPENDENCIES_STANDALONE_ALL      += $(WINDOWS_DEPENDENCIES_STANDALONE_ALL)
  DEPENDENCIES_STANDALONE_UI_ALL   += $(WINDOWS_DEPENDENCIES_STANDALONE_UI_ALL)
...
# Launcher tool
MACOS_DEPENDENCIES_LAUNCHER = \
  LIBAUDIOTOOLBOX \
  LIBCOREFOUNDATION
  
MACOS_DEPENDENCIES_LAUNCHER_BIN =
...
# Standalone dependencies
MACOS_DEPENDENCIES_STANDALONE = \
  LIBAUDIOTOOLBOX \
  LIBCOREFOUNDATION

MACOS_DEPENDENCIES_STANDALONE_OPT =

MACOS_DEPENDENCIES_STANDALONE_UI = \
  LIBAUDIOTOOLBOX \
  LIBCOREFOUNDATION

MACOS_DEPENDENCIES_STANDALONE_WRAP =

MACOS_DEPENDENCIES_STANDALONE_WRAP_OPT =

MACOS_DEPENDENCIES_STANDALONE_BIN =

MACOS_DEPENDENCIES_STANDALONE_BIN_OPT =

MACOS_DEPENDENCIES_STANDALONE_UI_BIN = 

MACOS_DEPENDENCIES_STANDALONE_ALL = \
  $(MACOS_DEPENDENCIES_STANDALONE) \
  $(MACOS_DEPENDENCIES_STANDALONE_OPT) \
  $(MACOS_DEPENDENCIES_STANDALONE_WRAP) \
  $(MACOS_DEPENDENCIES_STANDALONE_WRAP_OPT) \
...
MACOS_DEPENDENCIES_STANDALONE_UI_ALL = \
  $(MACOS_DEPENDENCIES_STANDALONE_UI) \
  $(MACOS_DEPENDENCIES_STANDALONE_UI_BIN)
...
ifeq ($(PLATFORM),MacOS)
  ...
  DEPENDENCIES_LAUNCHER            += $(MACOS_DEPENDENCIES_LAUNCHER)
  DEPENDENCIES_LAUNCHER_BIN        += $(MACOS_DEPENDENCIES_LAUNCHER_BIN)
  ...
  DEPENDENCIES_STANDALONE          += $(MACOS_DEPENDENCIES_STANDALONE)
  DEPENDENCIES_STANDALONE_UI       += $(MACOS_DEPENDENCIES_STANDALONE_UI)
  DEPENDENCIES_STANDALONE_WRAP     += $(MACOS_DEPENDENCIES_STANDALONE_WRAP)
  DEPENDENCIES_STANDALONE_BIN      += $(MACOS_DEPENDENCIES_STANDALONE_BIN)
  DEPENDENCIES_STANDALONE_UI_BIN   += $(MACOS_DEPENDENCIES_STANDALONE_UI_BIN)
  DEPENDENCIES_STANDALONE_ALL      += $(MACOS_DEPENDENCIES_STANDALONE_ALL)
  DEPENDENCIES_STANDALONE_UI_ALL   += $(MACOS_DEPENDENCIES_STANDALONE_UI_ALL)
